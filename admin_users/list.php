...
<div class="main-container">
    ...
    <div class="d-flex justify-content-end mb-3"> 
        <a href="/admin_users/add.php" class="add-btn"> 
                    ...
                    <tr data-role="<?= htmlspecialchars($u['role']) ?>" data-status="<?= htmlspecialchars($u['status'] ?? 'active') ?>">
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="/users/edit.php?id=<?= $u['id'] ?>" class="btn-icon edit" title="Edit User">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="/users/delete.php?id=<?= $u['id'] ?>" class="btn-icon delete" title="Delete User"
